...
<%
    List<Users> items = (List<Users>)request.getAttribute("users");
    int total_items = (int)request.getAttribute("total");
%>
...
<div class="text-area">
    ...
    <h2><b>Тут отоброжаются все зарегавшиеся пользователи</b></h2>
</div>
                    ...
                    <div class="cart-table clearfix">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                ...
                                <td class="price">
                                    <span><%=f.getTelnum()%> </span>
                                </td>

                                <td class="cart_prodict_desc">
                                    <span><%=f.getPassword()%> </span>
                                </td>
                                <td class="">
...
<%--&lt;%&ndash;                            <li><span>Количество людей которым принадлежат ${total} товаров - 5 </span> <span></span></li>&ndash;%&gt;--%>
<%--                        </ul>--%>
<%--                    </div>--%>
<%--                </div>--%>
            </div>
